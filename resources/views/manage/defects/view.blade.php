	...
	<div class="row">
        <div class="panel panel-default panel-body" style="margin-top:-1.25em;">
            <div class="col-md-12" style="margin-top:-1em;">
                <h3 class="text-center"><b>Manage Defect All<i class="mdi mdi-book" aria-hidden="true"></i></b></h3>
                <h6 class="text-center"><b>Select group of manage defect</b></h6>
				...
				<thead>
					<tr class="width-100">
                        ...
                        <th class="text-center align-middle width-15">
                            <span class="is-hidden-mobile"><b>Manage Defect</b></span>
                            <span class="is-hidden-tablet" style="font-size:0.5em;"><b>Manage Defect</b></span>
                        </th>
					</tr>
				</thead>
				<tbody>
                        ...
                        <tr id="tr-{{$groupID}}" class="width-100">
                            ...
                            <td class="text-center align-middle width-15">
                                <a href="{{ asset('/manage-defect/group/'.$groupID)}}"><button class="is-hidden-tablet btn btn-manage"><i class="mdi mdi-cube-unfolded" aria-hidden="true"></i></button><button class="is-hidden-mobile btn btn-manage"><span class="is-hidden-mobile">Manage</span> <i class="mdi mdi-cube-unfolded" aria-hidden="true"></i></button></a>
                            </td>
                        </tr>
                    @endfor
				</tbody>
