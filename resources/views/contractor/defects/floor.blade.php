        ...
        <div class="panel panel-default panel-body" style="margin-top:-1.25em;">
            <div class="col-md-12" style="margin-top:-1em;">
				<div class="col-md-2 mt-3">
                    <a href="{{asset('/view-defect/group/'.$id)}}" style="text-decoration:none;"><button class="form-control">Back <i class="mdi mdi-step-backward" aria-hidden="true"></i></button></a>
				</div>
				<div class="col-md-offset-1 col-md-6 text-center align-middle">
					...
					<a href="{{asset('/view-defect/group/'.$id)}}"><button class="btn-min btn-detail-view align-middle text-center">View Manage Defect <i class="mdi mdi-cube-unfolded" aria-hidden="true"></i></button></a>
				</div>
